...
import PublicStadiumsSearchTable from '@/components/stadiums/PublicStadiumsSearchTable'
import { getPublicStadiums } from '@/lib/db/stadiums'

export default async function PublicStadiumsPage() {
  const stadiums = await getPublicStadiums()
        ...
        <div className="mx-auto max-w-[74rem]">
          <section className="relative overflow-hidden rounded-xl border border-emerald-800/70 bg-[linear-gradient(165deg,#1f9f4a_0%,#0e8a3a_18%,#087531_40%,#0f8a3d_58%,#0a6f31_78%,#0a5a2a_100%)] p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.2),inset_0_-2px_10px_rgba(0,0,0,0.2),0_8px_18px_rgba(0,0,0,0.2)] sm:p-6">
            ...
            <div className="relative z-10">
              <Suspense>
                <PublicStadiumsSearchTable stadiums={stadiums} />
              </Suspense>
            </div>
          </section>
        </div>
